...
_xi_model_uid = geoi_settings.XINFERENCE_EMBEDDING_MODEL
_xi_base_url = geoi_settings.XINFERENCE_API_URL
...
def get_embedding_model(model_uid):
    xi_embed = XinferenceEmbedding(
        model_uid=model_uid,
        base_url=_xi_base_url,
        timeout=60,
    )
    return xi_embed

xi_default_embedding = get_embedding_model(_xi_model_uid)
